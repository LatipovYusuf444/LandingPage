...
import dom2 from '../assets/uy2.webp';
...
const Kvartira = () => {
  ...
  return (
    ...
    >
      <div className='pt-20 sm:pt-[100px] lg:pt-[145px] pl-4 sm:pl-10 lg:pl-[124px]'>
        <motion.p
    ...
    mt-10 lg:mt-0 ml-0 lg:ml-30
    shadow-[0px_25px_80px_-10px_rgba(0,0,0,0.45)]
    rounded-xl
  "
        src={dom2}
        alt=""
